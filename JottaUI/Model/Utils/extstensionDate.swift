...
extension Date {
    func dateinseconds(_ timeinterval: TimeInterval) -> Date {
    ...
    /*
     var test: Date {
         let seconds: TimeInterval = 1625472000 // Example seconds since 1970-01-01
...
extension String {
    /*
     ...
     let dateString = "2025/07/04 06:37:22"
     let dateFormatter = DateFormatter()
     dateFormatter.dateFormat = "yyyy/MM/dd HH:mm:ss"
