...
actor ActorConvertDumpData {
    ...
    func convertStringToData(_ stringarray: [String]) async -> [Data] {
        Logger.process.debugThreadOnly("ActorConvertDumpData: convertStringToData()")
    ...
    func convertDataToBackup(_ dataarray: [Data], _ excludegit: Bool) async -> [Files] {
        Logger.process.debugThreadOnly("ActorConvertDumpData: convertDataToBackup()")
        var converted = [Files]()
